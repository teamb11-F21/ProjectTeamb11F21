...
const cacheName = '_75ProjectTeamb10-2021-11-02 13:13:21.482175'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeamb10'.length) === '_75ProjectTeamb10') {
